/* libspire_pdu.h generated by valac 0.12.0, the Vala compiler, do not modify */


#ifndef __R__OPERADORES_EDWINDLC_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_PDU_BIN_WIN_LIBSPIRE_PDU_H__
#define __R__OPERADORES_EDWINDLC_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_PDU_BIN_WIN_LIBSPIRE_PDU_H__
...
typedef enum  {
	...
	EDWINSPIRE_PDU_DCS_MESSAGE_CLASS_NONE
...
gchar* edwinspire_pdu_text_convert_StringToSevenBits (const gchar* Ascii);
