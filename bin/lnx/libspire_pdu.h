/* libspire_pdu.h generated by valac 0.16.1, the Vala compiler, do not modify */


#ifndef ___HOME_EDWINSPIRE_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_PDU_BIN_LNX_LIBSPIRE_PDU_H__
#define ___HOME_EDWINSPIRE_PROGRAMACION_PROYECTOSSOFTWARE_SOFTWARE_VALA_PROYECTOSVALA_PROYECTS_LIBSPIRE_PDU_BIN_LNX_LIBSPIRE_PDU_H__
...
edwinspirePDUSUBMITwithDCSGeneralDataCodingIndication* edwinspire_pdu_submi_twith_dcs_general_data_coding_indication_new (const gchar* phone, const gchar* message, gboolean statusreport, edwinspirePDUDCS_MESSAGE_CLASS msgclass);
edwinspirePDUSUBMITwithDCSGeneralDataCodingIndication* edwinspire_pdu_submi_twith_dcs_general_data_coding_indication_construct (GType object_type, const gchar* phone, const gchar* message, gboolean statusreport, edwinspirePDUDCS_MESSAGE_CLASS msgclass);
