...
namespace edwinspire.PDU {
	...
	public class FIRST_OCTET_SUBMIT: Octet {
		...
		/// </summary>
		public VALIDITY_PERIOD_FORMAT TP_VPF {
			set;
			get;
		}
		/// <summary>
	...
	public class SUBMIT: GLib.Object {
		...
		public FIRST_OCTET_SUBMIT FO {
			get;
			set;
			default = new FIRST_OCTET_SUBMIT();
		}
		/// <summary>
		...
		public PHONE_INFORMATION PHONE {
			get;
			set;
		}
		/// <summary>
		...
		/// Periodo de validez
		/// </summary>
		public VALIDITY_PERIOD TP_VP {
			private set;
			get;
		}
		public TextPDUText Message {
			get;
			set;
		}
		/// <summary>
