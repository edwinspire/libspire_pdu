...
private string iHex{get; private set; default = "";}
private int iDec{get; private set; default = 0;}
private string iBin{get; private set; default = "";}
...
public PDU_ALPHABET Alphabet{get; set;}
		/// <summary>
		/// Construido
		/// </summary>
public TextPDUText(){
