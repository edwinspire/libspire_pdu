...
public bool TP_RP{private set; get; default = false;}
...
public bool TP_UDHI{get; private set; default = false;}
...
public PHONE_INFORMATION SMSC{get; private set;}

[Description(nick = "First Octet", blurb = "Primer Octeto")]
public FIRST_OCTET_DELIVER FO{get; private set;}

[Description(nick = "Sender", blurb = "Informacion del Sender")]
public PHONE_INFORMATION Sender{get; internal set;}

[Description(nick = "PID", blurb = "Protocol Identifier")]
	public IProtocolIdentifier PID{get; private set;}

[Description(nick = "DCS", blurb = "Data coding scheme")]
	public IDataCodingScheme DCS{get; private set; } // = new DATA_CODING_SCHEME();
		/// <summary>
		/// Service Centre TimeStamp
		/// </summary>
	public TP_SCTS SCTS{get; internal set; default = new TP_SCTS.from_values(1990, 1, 1);}
		/// <summary>
		/// Longitud de los datos del usuario
		/// </summary>
	public Octet UDL{private set; get; default = new Octet();}
		/// <summary>
		/// Mensaje de texto
		/// </summary>
