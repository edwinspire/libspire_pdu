...
namespace edwinspire.PDU {
	public interface IDataCodingScheme:Octet {
		public abstract PDU_ALPHABET Alpha {
			get;
			set;
		}
		[CCode(notify = false)]
		internal abstract bool decoding {
			set;
			get;
		}
		[CCode(notify = false)]
		internal abstract bool encoding {
			set;
			get;
		}
	...
	public class DCS_GeneralDataCodingIndication:IDataCodingScheme,Octet {
		[CCode(notify = false)]
		internal bool decoding {
			set;
			get;
		}
		[CCode(notify = false)]
		internal bool encoding {
			set;
			get;
		}
